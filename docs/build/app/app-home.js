    ...
    render() {
        ...
        return (h("section", { class: "app-home" },
            h("section", { class: "difficulty-controls" },
                h("button", { class: `mdc-button ${this.difficultyLevel === "easy"
                        ? OUTLINED_BUTTON
                        : ""}`, onClick: this.setDifficulty.bind(this, EASY), disabled: this.isRunning }, "Easy"),
                h("button", { class: `mdc-button ${this.difficultyLevel === "medium"
                        ? OUTLINED_BUTTON
                        : ""}`, onClick: this.setDifficulty.bind(this, MEDIUM), disabled: this.isRunning }, "Medium"),
                h("button", { class: `mdc-button ${this.difficultyLevel === "hard"
                        ? OUTLINED_BUTTON
                        : ""}`, onClick: this.setDifficulty.bind(this, HARD), disabled: this.isRunning }, "Hard")),
